...
@implementation NTClockRunView

+ (NTClockRunView *)loadInstanceOfViewFromNib
{
	
    return [[[NSBundle mainBundle] loadNibNamed: @"NTClockRunView"
										  owner: nil
...
- (id) awakeAfterUsingCoder: (NSCoder *)aDecoder
{
	...
	if ( loadedFromSimpleVuew ) {
        ...
        NTClockRunView *clockRunView = [NTClockRunView loadInstanceOfViewFromNib];
		
        clockRunView.frame                  = self.frame;
        clockRunView.autoresizingMask       = self.autoresizingMask;
        clockRunView.alpha                  = self.alpha;
        clockRunView.userInteractionEnabled = self.userInteractionEnabled;
